...
variable "domain_name" {
  description = "Base domain students registered (e.g., southrakkasmedia.com)."
  type        = string
  default     = "southrakkasmedia.com"
}

variable "app_subdomain" {
  description = "App hostname prefix (e.g., app.southrakkasmedia.com)."
  type        = string
  default     = "app"
}
...
variable "route53_hosted_zone_id" {
  ...
  validation {
    condition     = var.route53_hosted_zone_id == "Z00021892WE8NHJ89CAOJ" || can(regex("^[A-Z0-9]{20}$", var.route53_hosted_zone_id))
...
variable "cloudfront_acm_cert_arn" {
  description = "ACM certificate ARN in us-east-1 for CloudFront (covers a4l-class7.com and app.southrakkasmedia.com)."
  type        = string
  default     = ""
}