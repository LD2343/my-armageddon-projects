...
# Look up the Sao Paulo (gru) Transit Gateway from gru
# data "aws_ec2_transit_gateway" "gru_tgw01" {
#   provider = aws.gru   # ← assumes you have this alias for sa-east-1
...
#   # filter {
#   #   name   = "tag:Name"
#   #   values = ["gru-medical-gru-tgw01", "*gru*tgw*"]
#   # }
