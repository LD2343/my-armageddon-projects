...
# # RDS Subnet Group
# resource "aws_db_subnet_group" "gru_rds_subnet_group01" {
...
#   db_subnet_group_name   = aws_db_subnet_group.gru_rds_subnet_group01.name
#   vpc_security_group_ids = [aws_security_group.gru_rds_sg01.id]
