...
# resource "aws_iam_role_policy" "gru_allow_tokyo_db_secret" {
#   name = "gru-allow-tokyo-db-secret"
#   role = aws_iam_role.gru_ec2_role.name
...
#           "secretsmanager:DescribeSecret"
#         ]
#         Resource = "arn:aws:secretsmanager:ap-northeast-1:497589205696:secret:edo/rds/mysql*"
#       }
#     ]
#   })
# }