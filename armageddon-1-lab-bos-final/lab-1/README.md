# Armageddon lab 1  |  Class 7: Zion  |  Group: Brotherhood Of Steel

---

<sup>lab 1 diagram</sup>![lab 1 diagram](./screen-captures/lab1-diagram-1-final.png)
...
3. **Security group rules + IAM access proof**
...
sc<sup>4</sup>![4 - add?note=first\_note](./screen-captures/4-note-1.png)
...
sc<sup>5</sup>![5 - add?note=2nd\_note](./screen-captures/5-note-2.png)

sc<sup>6</sup>![6 - add?note=3rd\_note](./screen-captures/6-note-3.png)
...
aws ec2 describe-instances \
  --filters "Name=tag:Name,Values=bos-ec201" \
...
### 6.5 Verify RDS Security Group Rule (works)

```bash
aws ec2 describe-security-groups \
  --filters "Name=tag:Name,Values=bos-rds-sg01" \
...
### 6.6 Verify Secrets Manager Access (run command inside ec2 sessions manager) (works)
...
- *note: you can also click the link in the email alert to view the alarm parameters in more detail in AWS console
