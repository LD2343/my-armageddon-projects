...
# Connecting Tokyo and São Paulo regions via Transit Gateway (peering)
...
- the transit gateway accepter is the transit gateway id
...
- go to Tokyo > vpc > Transite gateway route tables > select tgw route table > actions > create static route
- fill in the São Paulo CIDR and choose attachement > create static route
  
sc<sup>59-d</sup>![TGW connecting](./screen-captures/59-d.png)  

- go to São Paulo > vpc > Transite gateway route > select tgw > actions > create static route
- fill in Tokyo CIDR and choose attachement > create static route
...
!!!!!!!!!!!!!!!!!!!!!!!!!!cirle back to get deliverables right
...
**IMPORTANT!!! - if you use my terraform scripts I've changed them to create proof and the subsequent files needed for the deliverables inside a folder inside python. Therefore before you start this scripts section create a folder name: lab3-audit-pack in your python folder. The scripts will create files in this folder**

sc<sup>64-9aa</sup>![Python deliverables folder](./screen-captures/64-9aa.png)
...
# meeting #13 - my-armageddon-project-1
### Group Leader: Omar Fleming
### Team Leader: Larry Harris
### Date: 02-03-26 (Tuesday)
### Time: 8:00pm -  9:00pm est. - Zion
### Time: 9:00pm -  pm est. - Armageddon
