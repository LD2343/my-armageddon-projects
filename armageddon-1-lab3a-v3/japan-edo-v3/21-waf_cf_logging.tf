...
resource "aws_s3_bucket_acl" "cloudfront_logs_acl" {
  bucket = "cl-global-bucket-497589205696" # or your current ACL; this is just to ensure ACLs are active
...
resource "aws_s3_bucket_public_access_block" "cloudfront_logs" {
  bucket = "cl-global-bucket-497589205696"
...
#Fallback/Alternative: Bucket policy (works even with Bucket owner enforced)
    ...
    Statement = [
      {
        ...
        Action   = "s3:PutObject"
        Resource = "arn:aws:s3:::cl-global-bucket-497589205696/*"
      }
    ]
  })
}
